...
let stdin = Unix.openfile "./stdin" [Unix.O_CREAT] 550 in
let stdout = Unix.openfile "./stdout" [Unix.O_CREAT] 550 in
let stderr = Unix.openfile "./stderr" [Unix.O_CREAT] 550 in
